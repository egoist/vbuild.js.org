  ...
  <div class="page">
    ...
    <section class="slide" id="slide0">
      <h1 class="site-name">
        ...
        <span class="description">Refined webpack development experience</span>
      </h1>
    ...
    <section class="slide" id="slide1">
      ...
      <window title="~/my-project/index.js">
    ...
    <section class="slide" id="slide4">
      ...
      <window title="~/my-project/vbuild.config.js">
    ...
    <section class="slide" id="slide5">
      <h1>Almost There!</h1>
      <a href="https://github.com/egoist/vbuild" class="btn"><svg id="i-book" viewBox="0 0 32 32" width="32" height="32" fill="none" stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round" stroke-width="6.25%">
    <path d="M16 7 C16 7 9 1 2 6 L2 28 C9 23 16 28 16 28 16 28 23 23 30 28 L30 6 C23 1 16 7 16 7 Z M16 7 L16 28" />
</svg> Check out on GitHub</a>
    </section>
  </div>
</template>
